...
<body>
    <h1>Registrar delegado</h1>
    <?php
        echo 'Usuario: '.$nombre_usuario;
    ?>
    <!--Formulario de registro de un apoyo-->
    <form action="modelo/reg_delegado.php" method = "post">
        <h2>Delegado</h2>
        <label for="">Código:</label> 
        <input type="text" name="id_delegado" id="" required>
        <br><br>
        <label for="">Nombre:</label> 
        <input type="text" name="nombre_delegado" id="" required>
        <br><br>
        <label for="">Correo:</label> 
        <input type="text" name="correo_delegado" id="" required>
        <br><br>
        <label for="">Telefono:</label> 
        <input type="text" name="telefono_delegado" id="" required>
        <br><br>
        <label for="">Password:</label> 
        <input type="text" name="password_delegado" id="" required>
        <br><br>
